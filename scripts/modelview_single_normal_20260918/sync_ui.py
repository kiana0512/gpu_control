...
FILES=[
 ('/home/lilithgames/下载/ModelViewCreator_flux_Single-view Generation (1).json','ModelViewCreator_flux_Single-view Generation.json','a05adefe9124848b8e294b3acb2a4562eeec8c8b3e0838e71572280e231c2123'),
 ('/home/lilithgames/下载/ModelViewCreator_flux_fill_inpaint -View generation (2).json','ModelViewCreator_flux_fill_inpaint -View generation.json','1b078109ac3342c00dd2ae013561084f680439fb92e56ba001e4c591d9fb5fa6'),
]
...
def sync(node):
 ...
 for index,(source,base,expected) in enumerate(FILES):
  ...
  staged=source
  if host:
   staged=f'/tmp/single-normal-20260918-{index}.json'
  ...
  command(['sudo','-n','cp','-an',target,target+'.before-single-normal-20260918'])
