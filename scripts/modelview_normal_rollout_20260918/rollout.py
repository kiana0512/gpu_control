...
Run with the production API environment and /tmp/modelview-normal-20260918 bundle.
Does not enable the candidate. Publication follows the separately verified API rollout.
"""
...
BUNDLE = Path("/tmp/modelview-normal-20260918/manifest.yaml")
EVIDENCE = Path("/srv/gpu-control/jobs/deployment-modelview-normal-20260918")
SOURCE = Path("/tmp/modelview-normal-20260918/input")
...
async def main():
    ...
    async with database.session() as db:
        ...
        assert (
            ...
            == "08a54d3f53e804749aab4044a26023342e82ea0138b78f2b2e7f11b7b1046685"
        )
