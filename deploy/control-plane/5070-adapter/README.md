...
This directory records the initial post1 layer. The accepted deployment now uses
post3; see [the final release manifest](../../../artifacts/control-plane/5070ti-20260911/README.md)
for runtime identities, source tags, and restoration instructions.
