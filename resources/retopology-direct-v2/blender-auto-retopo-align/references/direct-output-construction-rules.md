...
5. After modifiers/conversion/join, finish only the fresh generated low: remove zero-area/degenerate faces and require finite coordinates. Record boundary, non-manifold, loose, duplicate, and orientation metrics as advisory diagnostics. Do not generate UVs in this stage. Never apply the finish to `SOURCE_HIGH`.
