...
| Cloth or leather becomes torn strips over a solid aggregate proxy | One fused export surface was forcibly split by face normal or coordinate clipping, then open fragments were independently reduced | Treat one recovered fused surface as inseparable and use the packaged one-pass whole-source controlled-reduction fallback at 50 percent |
