...
```bash
unzip blender-auto-retopo-align-server-package-v3.0.2.zip -d /opt/li3d/releases/
cd /opt/li3d/releases/blender-auto-retopo-align-server-package-v3.0.2
...
docker build \
  ...
  -f Dockerfile.layer \
  -t li3d/blender-auto-retopo-align:v3.0.2 .
```
