# Blender 自动拓扑与原坐标对齐服务器包 v3.0.14
...
```bash
unzip blender-auto-retopo-align-server-package-v3.0.14.zip -d /opt/li3d/releases/
cd /opt/li3d/releases/blender-auto-retopo-align-server-package-v3.0.14
...
docker build \
  ...
  -f Dockerfile.layer \
  -t li3d/blender-auto-retopo-align:v3.0.14 .
```
