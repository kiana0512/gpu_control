...
`1.6.22-retopo-reliability-v1`、三台 Linux Blender Worker
`1.4.24-retopo-reliability-v1`、数据库 `20260810_0013`。当前总状态为
...
清理模型缓存。自动拓扑对齐包 v3.0.3 增加输出契约恢复、认证刷新持久化和逐项门禁诊断；v3.0.2
