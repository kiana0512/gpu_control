...
`1.6.39-retopo-trained-skill-v1`、三台 Linux Blender Worker
`1.4.39-retopo-trained-skill-v1`、数据库 `20260810_0013`。当前总状态为
...
清理模型缓存。自动拓扑对齐包 v3.0.17 统一 FBX/GLB/GLTF/OBJ 的只读高模准备入口，正式加载训练
